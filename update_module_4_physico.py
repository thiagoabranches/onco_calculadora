...
def run_backend():
    print("--- ATUALIZANDO BANCO: PARÂMETROS FÍSICO-QUÍMICOS (M-Q) ---")
    ...
    try:
        ...
        if not target_sheet:
            print("[ERRO] Aba correta não encontrada.")
            return
    ...
    print("Importando dados físico-químicos...")
    count = 0
...
def run_frontend():
    print("--- ATUALIZANDO FRONTEND (NOVA COLUNA ℹ️) ---")
            ...
            <table class="w-full text-sm text-left">
                <thead class="bg-slate-50 uppercase text-xs font-bold text-slate-500 border-b">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center text-blue-600 w-24">Parâmetros Físico-Químicos</th> <th class="px-2 py-3 text-center">SG 5%</th>
