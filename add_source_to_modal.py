    ...
    const App = {
            ...
            Object.keys(cats).sort().forEach(cat => {
                ...
                cats[cat].sort((a,b) => a.name.localeCompare(b.name)).forEach(m => {
                    ...
                    if (m.is_cytotoxic === 1) {
                        ...
                        cytoBadge = '<span class="cyto-badge" title="Citotóxico (Fonte: NIOSH 2024)">☣️</span>';
                    }
        ...
        modalPhys: (id) => {
            ...
            App.showModal(`${m.name} - Físico-Químico`, [
                ...
                // LINHA DE FONTE NIOSH ADICIONADA AQUI
...
print("Frontend atualizado: Fonte NIOSH incluída no modal.")
