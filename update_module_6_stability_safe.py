...
def run_frontend():
    # Emoji removido do print para evitar erro no Windows
            ...
            <table class="w-full text-sm text-left">
                <thead class="bg-slate-50 uppercase text-xs font-bold text-slate-500 border-b">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center text-amber-600 w-16">Estab.</th>
