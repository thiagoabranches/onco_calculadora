            ...
            <table class="w-full text-sm text-left">
                <thead class="bg-slate-50 uppercase text-xs font-bold text-slate-500 border-b">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center w-24">Farmacotécnica</th> <th class="px-4 py-3 text-center text-blue-600 w-24">Fís-Quím</th> <th class="px-2 py-3 text-center">SG 5%</th>
