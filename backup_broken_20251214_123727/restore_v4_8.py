...
print(f"📦 Criando backup do estado atual em '{backup_dir}'...")
for f in os.listdir('.'):
...
# Extraídos dos seus CSVs originais para garantir integridade
dados_v4_8 = [
    {"nome": "Aflibercepte", "cat": "Antiangiogênico", "apres": "Frasco 100 mg/4 mL | 200 mg/8 mL", "concMin": 0.6, "concMax": 8.0, "sg5": "Sim", "sf09": "Sim"},
    ...
    {"nome": "Atezolizumabe", "cat": "Anticorpo Monoclonal", "apres": "Frasco 1200 mg | 840 mg", "concMin": 3.2, "concMax": 16.8, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Azacitidina", "cat": "Hipometilante", "apres": "Frasco 100 mg", "concMin": 1.0, "concMax": 4.0, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Bacilo de Calmette Guérin", "cat": "Imunoterápico", "apres": "Frasco 40 mg", "concMin": 0, "concMax": 0, "sg5": "-", "sf09": "Sim"},
    {"nome": "Belinostat", "cat": "Inibidor HDAC", "apres": "Frasco 500 mg", "concMin": 1.0, "concMax": 2.0, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Bendamustina", "cat": "Alquilante", "apres": "Frasco 25 mg | 100 mg", "concMin": 0.2, "concMax": 0.6, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Bevacizumabe", "cat": "Anticorpo Monoclonal", "apres": "Frasco 100 mg | 400 mg", "concMin": 1.4, "concMax": 16.5, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Bleomicina", "cat": "Antibiótico", "apres": "Frasco 15 UI", "concMin": 3.0, "concMax": 15.0, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Bortezomibe", "cat": "Inibidor Proteassoma", "apres": "Frasco 3.5 mg", "concMin": 1.0, "concMax": 2.5, "sg5": "Não", "sf09": "Sim"},
    ...
    {"nome": "Carfilzomib", "cat": "Inibidor Proteassoma", "apres": "Frasco 10 | 30 | 60 mg", "concMin": 2.0, "concMax": 2.0, "sg5": "Sim", "sf09": "Não"},
    {"nome": "Carmustina", "cat": "Alquilante", "apres": "Frasco 100 mg", "concMin": 0.2, "concMax": 0.2, "sg5": "Sim", "sf09": "Não"},
    {"nome": "Cemiplimabe", "cat": "Anticorpo Monoclonal", "apres": "Frasco 350 mg", "concMin": 1.0, "concMax": 20.0, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Cetuximabe", "cat": "Anticorpo Monoclonal", "apres": "Frasco 100 | 500 mg", "concMin": 5.0, "concMax": 5.0, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Ciclofosfamida", "cat": "Alquilante", "apres": "Frasco 1g | 200 mg", "concMin": 2.0, "concMax": 20.0, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Cisplatina", "cat": "Platina", "apres": "Frasco 10 mg | 50 mg", "concMin": 0.5, "concMax": 1.0, "sg5": "Não", "sf09": "Sim"},
    {"nome": "Citarabina", "cat": "Antimetabólito", "apres": "Frasco 100 mg | 500 mg", "concMin": 0.1, "concMax": 100.0, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Dacarbazina", "cat": "Alquilante", "apres": "Frasco 100 mg | 200 mg", "concMin": 1.5, "concMax": 4.0, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Daratumumab", "cat": "Anticorpo Monoclonal", "apres": "Frasco 100 mg | 400 mg", "concMin": 0.4, "concMax": 3.6, "sg5": "Não", "sf09": "Sim"},
    ...
    {"nome": "Etoposídeo", "cat": "Inibidor Topoisomerase", "apres": "Frasco 100 mg", "concMin": 0.2, "concMax": 0.4, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Fluorouracil", "cat": "Antimetabólito", "apres": "Frasco 250 mg | 2.5 g", "concMin": 25.0, "concMax": 25.0, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Gencitabina", "cat": "Antimetabólito", "apres": "Frasco 200 mg | 1 g", "concMin": 0.1, "concMax": 38.0, "sg5": "Não", "sf09": "Sim"},
    ...
    {"nome": "Nab-paclitaxel", "cat": "Taxano", "apres": "Frasco 100 mg", "concMin": 5.0, "concMax": 5.0, "sg5": "Não", "sf09": "Não"},
    {"nome": "Nivolumabe", "cat": "Anticorpo Monoclonal", "apres": "Frasco 40 mg | 100 mg", "concMin": 1.0, "concMax": 10.0, "sg5": "Sim", "sf09": "Sim"},
    {"nome": "Oxaliplatina", "cat": "Platina", "apres": "Frasco 50 mg | 100 mg", "concMin": 0.2, "concMax": 2.0, "sg5": "Sim", "sf09": "Não"},
    ...
    {"nome": "Pemetrexede", "cat": "Antimetabólito", "apres": "Frasco 100 mg | 500 mg", "concMin": 0, "concMax": 0, "sg5": "Sim", "sf09": "Sim"},
...
cursor.execute('''
    CREATE TABLE medicamentos (
        ...
        name TEXT NOT NULL,
        category TEXT,
        concentration TEXT, -- Texto livre (ex: "Frasco 100mg | 500mg")
        concMin REAL,
        concMax REAL,
        sg5 TEXT,
        sf09 TEXT,
...
print("🛠️  Reconstruindo banco de dados v4.8...")
count = 0
for m in dados_v4_8:
    # Lógica simples de calculadora especial
    spec = ''
...
conn.commit()
conn.close()
print(f"✅ Banco restaurado com {count} medicamentos principais.")

# --- 4. RECONSTRUÇÃO DO HTML (V4.8 - ESTÁVEL) ---
html_code = """<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>OncoCalc Pro v4.8 (Estável)</title>
...
<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <div id="infusion-modal" class="modal hidden">
        <div class="modal-content" style="max-width: 600px;">
            <h3 class="text-xl font-bold mb-4">Protocolos de Infusão</h3>
    ...
    const App = {
        ...
        calc: () => {
            ...
            if(dose && dil) {
                // Cálculo simplificado assumindo conc=1 para volume aspirado (apenas ilustrativo na v4.8)
                // Foco na concentração final
                const finalConc = dose / dil; 
                const { concMin, concMax } = App.current;
                
                let status = "Faixa não definida";
                ...
                document.getElementById('result').innerHTML = `
                    <p class="text-sm text-gray-500">Concentração Final Estimada (Dose/Vol):</p>
...
# --- 5. RECONSTRUÇÃO DO SERVIDOR (APP.PY) ---
...
print("✅ RESTAURAÇÃO DA VERSÃO 4.8 CONCLUÍDA COM SUCESSO!")
print("   - Banco de dados reconstruído.")
print("   - Interface simplificada restaurada.")
print("   - Scripts antigos limpos.")
